...
def draw_menu(size,color):
    ...
    xl_brush = pygame.draw.rect(screen, 'black', [10, 10, 40, 40])
    pygame.draw.circle(screen, 'white', (30, 30), 20)
    l_brush = pygame.draw.rect(screen, 'black', [70, 10, 40, 40])
    pygame.draw.circle(screen, 'white', (90, 30), 15)
    m_brush = pygame.draw.rect(screen, 'black', [130, 10, 40, 40])
    pygame.draw.circle(screen, 'white', (150, 30), 10)
    s_brush = pygame.draw.rect(screen, 'black', [190, 10, 40, 40])
    pygame.draw.circle(screen, 'white', (210, 30), 5)
    brush_list=[xl_brush,l_brush,m_brush,s_brush]
    if size==20:
        pygame.draw.rect(screen,'green',[10,10,40,40],3)
    if size==15:
        pygame.draw.rect(screen,'green',[70,10,40,40],3)
    if size==10:
        pygame.draw.rect(screen,'green',[130,10,40,40],3)
    if size==5:
        pygame.draw.rect(screen,'green',[190,10,40,40],3)
